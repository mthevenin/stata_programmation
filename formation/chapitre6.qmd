...
On voit bien que la valeur de tvc pour id=1 et périodes=4 n'a pas été importée (_merge=2 dans un appariement classique). En revanche, pour id=2 on voit bien que l'information était incomplète dans la base tvc pour les périodes 3 et 4.  
