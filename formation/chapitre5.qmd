...
[**Programme du chapitre**](https://github.com/mthevenin/formation_stata/blob/master/programmes/chapitre5.md)
...
**Création variable**      | `generate` - `replace` - `egen` (exemple de fonctions associées)
...
::: callout_note
## TODO
Faire un topo sur les variables dates
